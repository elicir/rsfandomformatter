...
class Story:
            ...
            if not isinstance(item, str):
                ...
                if type == "message":
                    ...
                    if name_id != 0:
                        ...
                        if isinstance(chara_id, int) and len(characters) > 0: # ie. All does not need role check
    ...
    def __get_name_live2d(self, chara_id, chara_names, characters):
        try:
            ...
            if code not in chara_names:
                ...
                return str(chara_names[code]["name"]["en"])
        except:
            print(chara_id)
            print(characters)
            return ""
    ...
    def __format_line_chara_name(self, chara_names, args, name_id):
        name = chara_names[str(name_id)]["name"]["en"]
        speech = args["body"]["en"]
        if '(' in name:
            b = name.index('(')
